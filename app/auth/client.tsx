...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your RelateCRM Account",
        description: "Start organizing your client relationships today.",
    ...
    return {
      ...
      description: "Manage your team’s contacts, companies, and deals with ease.",
      button: "Sign in",
      helperText: (
        <>
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                All your contacts, companies, and deals in one workspace.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure authentication, effortless onboarding, and a clean CRM experience built for team productivity.
              </p>
            </div>
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center pt-2">{content.helperText}</div>
            </CardContent>
          </Card>
        </div>
      </section>
